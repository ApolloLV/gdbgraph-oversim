...
#ifndef __OVERSIM_HELLONODE_H_
#define __OVERSIM_HELLONODE_H_

#include <omnetpp.h>
#include "SimpleOverlayNode.h"

/**
 * This class represents a simple Overlay Node that only says 'hello' when initialized.
 */
class HelloNode: public SimpleOverlayNode {
